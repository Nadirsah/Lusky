...
<div class="office__page">
    <div class="title"><h3>Qida və içkilər</h3></div>
    <div class="container office__page__container"> 
        ...
        <div id="filter__category" class="office__filter col-md-12 col-lg-4">
            ...
            <input type="checkbox">Çay <br>
            <input type="checkbox">Quru meyvə <br>
            <input type="checkbox">Qəhvə<br>
            <input type="checkbox">Qənd <br>
            <input type="checkbox">Şirniyyat <br>
            <input type="checkbox">Soyuq içkilər <br>
            <input type="checkbox">Süd<br>
            <input type="checkbox">Un məhsulları<br>
            <input type="checkbox">Ədviyyat<br>
            </div>
