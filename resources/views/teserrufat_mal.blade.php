...
<div class="office__page">
    <div class="title"><h3>Təsərrüfat malları</h3></div>
    <div class="container office__page__container"> 
        ...
        <div id="filter__category" class="office__filter col-md-12 col-lg-4">
            ...
            <input type="checkbox">Birdəfəlik qablar<br>
            <input type="checkbox">Hava təravətləndirici<br>
            <input type="checkbox">Mətbəx Dəsmalı<br>
            <input type="checkbox">Mətbəx levazimatlari<br>
            <input type="checkbox">Sabun<br>
            <input type="checkbox">Salfetlər <br>
            <input type="checkbox">Tibbi ləvazimatlar<br>
            <input type="checkbox">Tualet kağızı<br>
            <input type="checkbox">Təmizlik Vasitələri<br>
            <input type="checkbox">Təmizləyici maddələr <br>
            <input type="checkbox">Xırdavat<br>
            <input type="checkbox">Zibil Paketi <br>
            <input type="checkbox">Əlcək<br>
            </div>
