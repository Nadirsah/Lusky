...
<form action="{{route('Steserrufatnov')}}" method="POST" enctype="multipart/form-data">
@csrf
  <div class="mb-3">
...
<div class="container">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><a href="{{'Editteserrufatnov/'.$datas['id']}}"><i class="fa-solid fa-pen-to-square text-info"></i></a>
    <a href="{{'deleteteserrufatnov/'.$datas['id']}}"><i class="fa-solid fa-trash-can text-danger"></i></a>
    </td>
