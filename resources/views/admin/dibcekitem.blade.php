...
<form action="{{route('Sdibcekitem')}}" method="POST" enctype="multipart/form-data">
@csrf
  <div class="mb-3">
...
<div class="container">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>{{$datas->about}}</td>
      <td>{{$datas->price}}</td>
      <td><a href="{{'Editdibcekitem/'.$datas['id']}}"><i class="fa-solid fa-pen-to-square text-info"></i></a>
    <a href="{{'deletedibcekitem/'.$datas['id']}}"><i class="fa-solid fa-trash-can text-danger"></i></a>
    </td>
