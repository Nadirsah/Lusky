...
<form action="{{route('Sdibceknov')}}" method="POST" enctype="multipart/form-data">
@csrf
  <div class="mb-3">
...
<div class="container">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><a href="{{'Editdibceknov/'.$datas['id']}}"><i class="fa-solid fa-pen-to-square text-info"></i></a>
    <a href="{{'deletedibceknov/'.$datas['id']}}"><i class="fa-solid fa-trash-can text-danger"></i></a>
    </td>
