...
<form action="{{route('Steserrufatitem')}}" method="POST" enctype="multipart/form-data">
@csrf
  <div class="mb-3">
...
<div class="container">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>{{$datas->about}}</td>
      <td>{{$datas->price}}</td>
      <td><a href="{{'Editteserrufatitem/'.$datas['id']}}"><i class="fa-solid fa-pen-to-square text-info"></i></a>
    <a href="{{'deleteteserrufatitem/'.$datas['id']}}"><i class="fa-solid fa-trash-can text-danger"></i></a>
    </td>
