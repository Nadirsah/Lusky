...
<div class="office__page">
    <div class="title"><h3>Ofis ləvazimatları</h3></div>
    <div class="container office__page__container"> 
        ...
        <div id="filter__category" class="office__filter col-md-12 col-lg-4">
            ...
            <div class="office__filter__number d-flex">
                <div><span>0</span><img src="{{asset('style_lucky/./public/images/icon/manat.svg')}}" alt="manat"></div>
                <div><span id="rangeValue">100</span><img src="{{asset('style_lucky/./public/images/icon/manat.svg')}}" alt="manat"></div>
            </div>
            <hr>
            <div>
...
@foreach($data as $datas)
    ...
    <div class="office__page__wrapper wrapper d-flex">
        <div class="office__page__item item justify-content-center col-12 col-md-6 col-xl-4">
                ...
                <div class="item__img"><a href="{{route('meh_detal')}}"><img src="./public/Products/1616154785bx80-3802_2.Wz70i.jpg" alt=""></a></div>
