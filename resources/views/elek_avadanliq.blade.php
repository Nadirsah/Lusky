...
<div class="office__page">
    <div class="title"><h3>Elektron avadanlıq</h3></div>
    <div class="container office__page__container"> 
        ...
        <div id="filter__category" class="office__filter col-md-12 col-lg-4">
            ...
            <input type="checkbox">Batareyalar<br>
            <input type="checkbox">Kartric<br>
            <input type="checkbox">Klaviatura <br>
            <input type="checkbox">Kompyuter üçün çanta <br>
            <input type="checkbox">Modem <br>
            <input type="checkbox">Mouse <br>
            <input type="checkbox">Power Bank <br>
            <input type="checkbox">Printer <br>
            <input type="checkbox">Telefon <br>
            <input type="checkbox">Təmizləyicilər <br>
            <input type="checkbox">Uzadıcı <br>
            <input type="checkbox">Yaddaş kart <br>
            </div>
