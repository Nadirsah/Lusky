    ...
    public function deletekategory($id)
    {
        ...
        return redirect('kategory');
            ...
            public function qidaitem()
            {
                ...
                return view('admin.qidaitem', compact('data', 'product', 'item'));
            }

            public function Storeqidaitem(Request $req)
            {
                $category = Items::findOrFail($req->items_id);
            ...
            public function editqidaitem($id)
            {
                ...
                return view('admin.editqidaitem', compact('item', 'product'));
            }

            public function updateqidaitem(Request $request, $id)
            {
